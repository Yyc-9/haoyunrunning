...
export default function CoachAccessPanel({ compact = false, onStudentBound }: CoachAccessPanelProps) {
  ...
  const redeemInvite = async () => {
    ...
    try {
      await postWithSession('/api/coach/redeem-invite', { code: inviteCode })
    ...
    <div className="apple-card p-6">
      <div className="mb-5 flex items-start justify-between gap-4">
        <div>
          ...
          <h2 className="text-xl font-bold text-apple-gray-900">教練權限與學員綁定</h2>
        </div>
      ...
      <div className={compact ? 'space-y-4' : 'grid gap-4 md:grid-cols-2'}>
        <div className="rounded-3xl bg-apple-gray-100 p-4">
          ...
          <input
            ...
            placeholder="GOODLUCK-COACH-2026"
