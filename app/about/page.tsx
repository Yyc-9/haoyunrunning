...
export default function AboutPage() {
  ...
  return (
    <div className="mobile-brand-page kinetic-page min-h-screen bg-white pt-20 sm:pt-24">
      ...
      <section className="kinetic-hero kinetic-reveal relative isolate flex min-h-[660px] overflow-hidden text-white sm:min-h-[720px]">
        ...
        <div className="container relative z-10 mx-auto flex w-full max-w-7xl flex-col justify-center px-5 py-14 sm:px-8 sm:py-16 lg:px-12 lg:py-20">
