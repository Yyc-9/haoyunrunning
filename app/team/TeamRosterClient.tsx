        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid gap-5 xl:grid-cols-2">
            {coaches.map((coach) => {
              ...
              return (
                <article key={coach.coachKey} className="overflow-hidden rounded-lg border border-black/10 bg-white shadow-sm">
                  <div className="grid sm:grid-cols-[190px_minmax(0,1fr)]">
                    <div className={`relative bg-apple-gray-100 sm:min-h-full ${imageUrl ? 'min-h-72' : 'min-h-36'}`}>
                      {imageUrl ? (
                        <Image
                          src={imageUrl}
                        ...
                        <UserRound className="absolute left-1/2 top-1/2 h-14 w-14 -translate-x-1/2 -translate-y-1/2 text-apple-gray-300" />
                      )}
                    </div>
                    ...
                    <div className="min-w-0 p-5 sm:p-6">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          <h3 className="text-2xl font-black text-apple-gray-950">{coach.displayName}</h3>
                      ...
                      <p className="mt-3 text-sm font-black text-apple-gray-700">{coach.role}</p>
                      <p className="mt-3 text-sm leading-7 text-apple-gray-600">{coach.bio}</p>
