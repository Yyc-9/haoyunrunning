...
insert into public.shop_products (
  ...
  ('1', '好运竞速跑步背心', '跑者服饰', 0, '私信咨询', '/goodluck-running-vest.jpg', 5, 0, '["团队装备"]'::jsonb, '[{"id":"purple-white","name":"紫电白","image":"/goodluck-running-vest.jpg"},{"id":"black-blue","name":"曜黑蓝","image":"/goodluck-running-vest-black.jpg"}]'::jsonb, '["XS","S","M","L","XL"]'::jsonb, 20, true),
  ('2', '好运跑步 T 恤', '跑者服饰', 0, '私信咨询', '/goodluck-running-tee.jpg', 5, 0, '["团队装备"]'::jsonb, '[]'::jsonb, '["XS","S","M","L","XL"]'::jsonb, 20, true),
  ('3', '好运跑步帽', '跑者配件', 0, '私信咨询', '', 5, 0, '["日常训练"]'::jsonb, '[]'::jsonb, '["S/M","L/XL"]'::jsonb, 20, true),
  ('4', '好运毛巾衣', '跑者服饰', 0, '私信咨询', '', 5, 0, '["赛后恢复"]'::jsonb, '[]'::jsonb, '["S","M","L","XL"]'::jsonb, 20, true),
  ('5', 'CALBOMB 蜂蜜柠檬能量胶', '运动补给', 0, '私信咨询', '/calbomb-energy-gel.png', 5, 0, '["训练补给","无添加认证"]'::jsonb, '[]'::jsonb, '[]'::jsonb, 30, true)
on conflict (id) do nothing;
