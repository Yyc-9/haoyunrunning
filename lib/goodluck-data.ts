...
export const coachProfiles = {
  chenShengQi: {
    ...
    nickname: '琦琦教練',
    role: '好運跑班創始人兼總教練',
    imageUrl: '/coaches/2026/avatars/chen-sheng-qi.jpg',
    fullBodyImageUrl: '/coaches/2026/chen-sheng-qi.jpg',
  ...
  liuChengEn: {
    ...
    nickname: '恩恩教練',
    role: '企業跑班與初中高階跑者訓練',
    imageUrl: '/coaches/2026/avatars/liu-cheng-en.jpg',
    fullBodyImageUrl: '/coaches/2026/liu-cheng-en.jpg',
  ...
  liuJunWei: {
    name: '劉鈞瑋教練',
    role: '週三竹北夜跑班教練',
    imageUrl: '/coaches/2026/avatars/liu-jun-wei.jpg',
    fullBodyImageUrl: '/coaches/2026/liu-jun-wei.jpg',
    bio: '好運跑班教練，負責週三竹北夜跑班的課程帶領與學員訓練陪伴。',
    specialties: ['夜間團練帶領', '跑者訓練陪伴'],
    style: '依照課程安排帶領團練，協助學員穩定完成每一堂訓練。',
    achievements: ['好運跑班週三竹北夜跑班教練'],
  },
  wuPeiCi: {
    name: '吳珮慈教練',
    role: '初階跑者與跑者肌力體能訓練',
    imageUrl: '/coaches/2026/avatars/wu-pei-ci.jpg',
    fullBodyImageUrl: '/coaches/2026/wu-pei-ci.jpg',
  ...
  bianbian: {
    ...
    nickname: '扁扁',
    role: '初階跑者、特殊族群與肌力訓練',
    imageUrl: '/coaches/2026/avatars/bianbian.jpg',
    fullBodyImageUrl: '/coaches/2026/bianbian.jpg',
  ...
  wuWeiQiao: {
    name: '鄔惟喬教練',
    role: '跑班教練與馬拉鬆訓練營助教',
    imageUrl: '/coaches/2026/avatars/wu-wei-qiao.jpg',
    fullBodyImageUrl: '/coaches/2026/wu-wei-qiao.jpg',
  ...
  luoPeiCi: {
    name: '羅珮慈教練',
    role: '初中階跑者週期訓練規劃',
    imageUrl: '/coaches/2026/avatars/luo-pei-ci.jpg',
    fullBodyImageUrl: '/coaches/2026/luo-pei-ci.jpg',
  ...
  laiXinHong: {
    ...
    nickname: '小黑教練',
    role: '初階跑姿建立與企業跑班規劃',
    imageUrl: '/coaches/2026/avatars/lai-xin-hong.jpg',
    fullBodyImageUrl: '/coaches/2026/lai-xin-hong.jpg',
  ...
  zhouXianFeng: {
    ...
    imageUrl: '/coaches/2026/avatars/zhou-xian-feng.jpg',
    fullBodyImageUrl: '/coaches/2026/zhou-xian-feng.jpg',
  ...
  yangShengHao: {
    name: '楊陞豪教練',
    role: '初階跑姿建立與社團課程規劃',
    imageUrl: '/coaches/2026/avatars/yang-sheng-hao.jpg',
    fullBodyImageUrl: '/coaches/2026/yang-sheng-hao.jpg',
  ...
  luoMinYao: {
    ...
    nickname: 'CC教練',
    role: '跑步生理學、戰術與個別化訓練',
    imageUrl: '/coaches/2026/avatars/luo-min-yao.jpg',
    fullBodyImageUrl: '/coaches/2026/luo-min-yao.jpg',
  ...
  xiaoHe: {
    ...
    nickname: '小赫助教',
    role: '好運跑班助教',
    imageUrl: '/coaches/2026/avatars/xiao-he.jpg',
    fullBodyImageUrl: '/coaches/2026/xiao-he.jpg',
  ...
  zhongLiChen: {
    ...
    nickname: '立宸助教',
    role: '好運跑班助教',
    imageUrl: '/coaches/2026/avatars/zhong-li-chen.jpg',
    fullBodyImageUrl: '/coaches/2026/zhong-li-chen.jpg',
  ...
  zhengYiQun: {
    ...
    nickname: '螞蟻助教',
    role: '好運跑班助教',
    imageUrl: '/coaches/2026/avatars/zheng-yi-qun.jpg',
    fullBodyImageUrl: '/coaches/2026/zheng-yi-qun.jpg',
...
function getCourseCoaches(course: Course): Coach[] {
  ...
  const coachesBySlug: Record<string, Coach[]> = {
    ...
    'zhubei-night-run-wednesday': [coachProfiles.chenShengQi, coachProfiles.liuJunWei, coachProfiles.liuChengEn, coachProfiles.bianbian, coachProfiles.zhouXianFeng, coachProfiles.zhengYiQun],
